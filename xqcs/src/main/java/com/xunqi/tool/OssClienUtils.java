...
public class OssClienUtils {
  ...
  private String accessKeyId = "LTAIEtNe1mXFEleo";
  private String accessKeySecret = "Y2lA54vUvYnjeDPbauMtVDnJ7YlWOo";
  //空间
...
//    }
   ...
   * @return 出错返回"" ,唯一MD5数字签名
   */
  public String uploadFile2OSS11(InputStream instream, String fileName) {
	  String ret = "";
	  try {
